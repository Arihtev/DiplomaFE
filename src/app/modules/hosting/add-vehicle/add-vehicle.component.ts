...
export class AddVehicleComponent implements OnInit {
  ...
  @ViewChild(FormMainComponent, { static: true })
  formMainComponent: FormMainComponent;
  @ViewChild(FormLocationComponent, { static: true })
  formLocationComponent: FormLocationComponent;
  @ViewChild(FormAmenitiesComponent, { static: true })
  formAmenitiesComponent: FormAmenitiesComponent;
  @ViewChild(FormDescriptionComponent, { static: true })
  formDescriptionComponent: FormDescriptionComponent;
  @ViewChild(FormRulesComponent, { static: true })
  formRulesComponent: FormRulesComponent;
  ...
  get formStepTwo() {
    return this.formLocationComponent
      ? this.formLocationComponent.locationForm
      : null;
  }

  get formStepThree() {
    return this.formDescriptionComponent
      ? this.formDescriptionComponent.descriptionForm
      : null;
  }

  get formStepFour() {
    return this.formAmenitiesComponent
      ? this.formAmenitiesComponent.amenitiesForm
      : null;
  }
